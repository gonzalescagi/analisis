...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ordenar = function () {
    ...
    HomeComponent.prototype.Insercion = function () {
        var aux; //alumnos
        var i = 0;
        for (var j = 1; j < this.dataSource.data.length; j++) {
    ...
    HomeComponent.prototype.InsercionNivel = function () {
        var aux; //alumnos
        var i = 0;
        for (var j = 1; j < this.dataSource.data.length; j++) {
            aux = this.dataSource.data[j];
    ...
    HomeComponent.prototype.busquedaLineal = function () {
        var n = -1;
        var aux = []; // nuevo arrelo temporal
    ...
    HomeComponent.prototype.busquedaLinealNivel = function () {
        var n = -1;
        var aux = []; // nuevo arrelo temporal
        for (var i = 0; i < this.dataSource.data.length; i++) {
